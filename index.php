...
$disallowed_extensions = ['php','com','bat','vbs'];  // must be an array. Extensions disallowed to be uploaded
...
$bootswatch_theme = 'darkly'; // Leave blank to use default Bootstrap theme - See: https://www.bootstrapcdn.com/bootswatch/
